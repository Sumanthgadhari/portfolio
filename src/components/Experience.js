          ...
          <div className="flex w-fit mx-auto">
            ...
            >
              <li className="py-2 md:py-3">
                Engineered Vaaradhi Portal, a management website for
                underprivileged students and orphans with educational
                facilities.
              </li>
              <li className="py-2 md:py-3">
                Collaborated with a team of 4 developers to ensure seamless
                integration of the application.
              </li>
              <li className="py-2 md:py-3">
                Implemented the MERN stack (MongoDB, Express.js, React.js,
                Node.js) with Google Cloud resulting in a 30% reduction in image
                loading.
              </li>
              <li className="py-2 md:py-3">
                Streamlined data entry and paperwork processes with the website,
                saving approximately 20 hours per week.
              </li>
            </ul>
          </div>
        </div>
