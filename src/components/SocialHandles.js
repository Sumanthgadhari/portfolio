  ...
  return (
    ...
    >
      ...
      <a
        ...
        href="https://www.linkedin.com/in/sumanth-sandra-207903151/"
        target="_blank"
        rel="noreferrer"
      >
        <FaLinkedin />
      ...
      <a
        className="text-white text-2xl md:text-xl transition duration-700 hover:scale-125"
        href="https://www.instagram.com/sumanth.gadhari/profilecard/?igsh=MWk0bnA3MGpnczlkOQ=="
        target="_blank"
        rel="noreferrer"
      >
        <FaInstagram />
      ...
      <a
        className="text-white text-2xl md:text-xl transition duration-700 hover:scale-125"
        href="https://x.com/sandra_sumanth"
        rel="noreferrer"
        target="_blank"
      >
        <FaXTwitter />
