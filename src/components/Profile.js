      ...
      <div className="p-5 mx-auto gap-2 flex flex-col md:pt-12 md:px-7 lg:py-20 lg:flex-row-reverse items-center min-h-fit">
        ...
        >
          <img
            ...
            alt="Sumanth Sandra"
            src={require("../assets/Images/sumanth.jpg")}
          />
        </div>
        <div className="lg:flex-grow lg:pr-4 lg:mr-14 flex flex-col md:mb-0 items-center text-center xl:scale-105">
          ...
          >
            Hello , I am{" "}
            <span className="text-dark-orange">Sumanth Sandra</span>
          </h2>
          <div
            data-aos="zoom-in-up"
            data-aos-duration="1500"
          ...
          >
            Currently pursuing a Master's in Project Management at UCD Michael
          ...
          >
            I have over three years of experience leading dispatcher services as
            a Systems Engineer.
          </p>
          <div
            data-aos="zoom-in-up"
          ...
          >
            ...
            <a
              href="https://drive.google.com/file/d/1IxFsyx5y4-HNUDaWVoikWHnzZF2ODq3W/view?usp=drivesdk"
              target="_blank"
              rel="noreferrer"
            >
