...
const experiences = [
  {
    ...
    responsibilities: [
      "Led a team of 9 in daily stand-ups, sprint planning, and retrospectives, using Scrum to increase the productivity of a leading confectionary manufacturer to ensure uninterrupted services. .",
      "Collaborated with product owners and stakeholders in an Agile environment to prioritize backlog and ensure on-time delivery of features. ",
      "Assisted the users to get critical issues solved within an MTTR of 4 hours or 1 day to avoid huge business impact.",
